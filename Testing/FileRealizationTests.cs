...
namespace Testing
{
    ...
    public class FileRealizationTests
    {
        ...
        {
            IDataModelInteraction dataModelInteraction = new FirstInteractionRealization(new DbInteractionRealize_File());
        ...
        {
            var fileRelize = new DbInteractionRealize_File();
            await fileRelize.ClearTable();
            IDataModelInteraction dataModelInteraction = new FirstInteractionRealization(fileRelize);
